...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex cursor-pointer select-none items-center text-main-foreground rounded-base px-3 py-1.5 text-sm border-2 border-transparent font-heading outline-none focus:border-border focus:bg-blue-500 focus:text-white data-[state=open]:border-border",
        className
      )}
      {...props}
    />
